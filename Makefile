...
TEST_SRC = tests/test_array_model_loader.cpp tests/test_array_loader_edge.cpp tests/test_cli_options.cpp tests/test_cli_validation_extra.cpp tests/test_rtm_engine.cpp tests/test_rtm_edge.cpp tests/test_rtm_acquisition.cpp tests/test_rtm_receivers.cpp tests/test_rtm_boundary.cpp tests/test_rtm_wavelet.cpp tests/test_rtm_inline_slice.cpp tests/test_rtm_result_builder.cpp tests/test_rtm_validation.cpp tests/test_image_io.cpp
